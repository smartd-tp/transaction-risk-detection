...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec 27 11:47:00 2017
...
class RBM(object):
    ...
    def __init__(self, num_visible, num_hidden, visible_unit_type='bin', main_dir='/Users/cp/Documents/job/smartdec/AL_COMPETITION/workfile'
, model_name='rbm_model', gibbs_sampling_steps=1, learning_rate=0.01, momentum = 0.9, 
l2 = 0.001, batch_size=10, num_epochs=10, stddev=0.1, verbose=0, plot_training_loss=True):
