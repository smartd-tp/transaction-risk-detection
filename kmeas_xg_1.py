...
train,val = train_test_split(cluster_1, test_size = 0.3,random_state=1)
...
for iter in range(10):
    ...
    train_y = train['Label']
    sm = SMOTEENN(ratio={1:int(train.shape[0]/l[iter])})##10太小，可以调大
...
k_means_final.to_csv("/Users/cp/Documents/job/smartdec/AL_COMPETITION/workfile/kmeans_xg_2.csv",index=False,sep=',')
